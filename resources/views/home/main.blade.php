...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('libs/bower_components/amazeui/dist/css/amazeui.min.css') }}"/>
...
<script src="{{ asset('libs/bower_components/amazeui/dist/js/amazeui.min.js') }}"></script>
<!--<![endif]-->
